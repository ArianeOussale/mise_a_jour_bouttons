    ...
    <section class="login-container">
        <div>
            ...
            <form action="traitement1.php" method="post">
                ...
                <input type="text" name="NomUtilisateur" placeholder="Nom d'utilisateur" required="required"/>
                <input type="password" name="MotDePasse" placeholder="Mot de passe" required="required"/>
                <input type="password" name="confirm_MotDePasse" placeholder="Confirmer Votre Mot de passe" required="required"/>
